        ...
        <nav x-data="{ selected: $persist('Dashboard') }">
            ...
            <div>
                ...
                <ul class="mb-6 flex flex-col gap-1">
                    ...
                    <li>
                        <a href="{{route('system-dashboard')}}"
                            class="menu-item group {{ Route::currentRouteName() === 'system-dashboard' ? 'menu-item-active' : 'menu-item-inactive' }}"
                            >
                            <svg :class="{{Route::currentRouteName()==='sytem-dashboard' ? 'menu-item-icon-active' : 'menu-item-icon-inactive'}}"
                    ...
                    <li>
                        ...
                        <div class="translate transform overflow-hidden"
                            ...
                            <ul :class="sidebarToggle ? 'xl:hidden' : 'flex'"
                                ...
                                <li>
                                    <a href="{{route('active-users')}}" class="menu-dropdown-item group"
                                ...
                                <li>
                                    <a href="{{ route('in-active-users') }}" class="menu-dropdown-item group"
                    ...
                    <li>
                        <a href="" @click.prevent="selected = (selected === 'Pages' ? '':'Pages')"
                            class="menu-item group Pages menu-item-inactive {{Route::currentRouteName() === 'category' ? 'menu-item-active' : 'menu-item-inactive'}}">
                            <svg :class="{{Route::currentRouteName() === 'category' ? 'menu-item-active' : 'menu-item-inactive'}}"
                                width="24" height="24" viewBox="0 0 24 24" fill="none"
                                xmlns="http://www.w3.org/2000/svg">
                                <path fill-rule="evenodd" clip-rule="evenodd"
                        ...
                        <div class="translate transform overflow-hidden"
                            ...
                            <ul :class="sidebarToggle ? 'lg:hidden' : 'flex'"
                                ...
                                <li>
                                    <a href="{{route('loadservice')}}" class="menu-dropdown-item group menu-dropdown-item-inactive"
                                        {{-- :class="page === 'faq' ? 'menu-dropdown-item-active' : 'menu-dropdown-item-inactive'" --}}
                                            >
                                        Services
                                    </a>
                                    ...
                                    <a href="api-keys.html" class="menu-dropdown-item group"
                                        ...
                                        <span class="absolute right-3 flex items-center gap-1">
                                            <span class="menu-dropdown-badge"
                                                :class="page === 'api' ? 'menu-dropdown-badge-active' :
                                ...
                                <li>
                                    <a href="integrations.html" class="menu-dropdown-item group"
                                        :class="page === 'integrations' ? 'menu-dropdown-item-active' :
                                            'menu-dropdown-item-inactive'">
                                        Integrations
                                        <span class="absolute right-3 flex items-center gap-1">
                                            <span class="menu-dropdown-badge"
                                                :class="page === 'integrations' ? 'menu-dropdown-badge-active' :
                                                    'menu-dropdown-badge-inactive'">
                                                New
                                            </span>
                                        </span>
                    ...
                    <!-- Menu Item AI -->
                    <li>
                        <a href="#" @click.prevent="selected = (selected === 'AI' ? '':'AI')"
                            class="menu-item group"
                            :class="(selected === 'AI') || (page === 'textGenerator' ||
                                page === 'imageGenerator' || page === 'codeGenerator' ||
                                page === 'videoGenerator') ? 'menu-item-active' : 'menu-item-inactive'">
                            <svg :class="(selected === 'AI') || (page === 'AI' || page === 'textGenerator') ?
                            'menu-item-icon-active' : 'menu-item-icon-inactive'"
                                width="24" height="24" viewBox="0 0 24 24" fill="none"
                                xmlns="http://www.w3.org/2000/svg">
                                <path
                                ...
                                <path d="M18.75 2.42969V2.43969M9.50391 9.875L9.50391 9.885M14.4961 9.875V9.885"
                        ...
                        <div class="translate transform overflow-hidden"
                            ...
                            <ul :class="sidebarToggle ? 'xl:hidden' : 'flex'"
                                ...
                                <li>
                                    <a href="video-generator.html" class="menu-dropdown-item group"
                                        :class="page === 'videoGenerator' ? 'menu-dropdown-item-active' :
                                            'menu-dropdown-item-inactive'">
                                        Video Generator
                                    </a>
                                </li>
                    ...
                    <!-- Menu Item Ecommerce -->
                    <li>
                        <a href="#" @click.prevent="selected = (selected === 'E-commerce' ? '':'E-commerce')"
                            class="menu-item group"
                            :class="(selected === 'E-commerce') || (page === 'products' || page === 'addProduct' ||
                                page === 'billing' || page === 'invoices' || page === 'singleInvoice' ||
                                page === 'createInvoice' || page === 'transactions' ||
                                page === 'singleTransaction') ? 'menu-item-active' : 'menu-item-inactive'">
                            <svg :class="(selected === 'E-commerce') || (page === 'products' || page === 'addProduct' ||
                                page === 'billing' || page === 'invoices' || page === 'singleInvoice' ||
                                page === 'createInvoice' || page === 'transactions' ||
                                page === 'singleTransaction') ? 'menu-item-icon-active' :
                            ...
                            <span :class="sidebarToggle ? 'xl:hidden' : ''"
                                class="absolute right-10 flex items-center gap-1">
                                <span class="menu-dropdown-badge"
                                    :class="page === 'products' ? 'menu-dropdown-badge-active' :
                                        'menu-dropdown-badge-inactive'">
                                    New
                                </span>
                            </span>
                            ...
                            <svg class="menu-item-arrow"
                                :class="[(selected === 'E-commerce') ? 'menu-item-arrow-active' :
                                    'menu-item-arrow-inactive', sidebarToggle ? 'xl:hidden' : ''
                                ]"
                                width="20" height="20" viewBox="0 0 20 20" fill="none"
                                xmlns="http://www.w3.org/2000/svg">
                        ...
                        <div class="translate transform overflow-hidden"
                            ...
                            <ul :class="sidebarToggle ? 'xl:hidden' : 'flex'"
                                class="menu-dropdown mt-2 flex flex-col gap-1 pl-9">
                                <li>
                                    <a href="products-list.html" class="menu-dropdown-item group"
                                        :class="page === 'products' ? 'menu-dropdown-item-active' :
                                            'menu-dropdown-item-inactive'">
                                        Products
                                    </a>
                                </li>
                                <li>
                                    <a href="add-product.html" class="menu-dropdown-item group"
                                        :class="page === 'addProduct' ? 'menu-dropdown-item-active' :
                                            'menu-dropdown-item-inactive'">
                                        Add Product
                                    </a>
                                </li>
                                <li>
                                    <a href="billing.html" class="menu-dropdown-item group"
                                        :class="page === 'billing' ? 'menu-dropdown-item-active' :
                                            'menu-dropdown-item-inactive'">
                                        Billing
                                    </a>
                                </li>
                                <li>
                                    <a href="invoices.html" class="menu-dropdown-item group"
                                ...
                                <li>
                                    <a href="single-invoice.html" class="menu-dropdown-item group"
                                        :class="page === 'singleInvoice' ? 'menu-dropdown-item-active' :
                                            'menu-dropdown-item-inactive'">
                                        Single Invoice
                                    </a>
                                </li>
                                <li>
                                    <a href="create-invoice.html" class="menu-dropdown-item group"
                                        :class="page === 'createInvoice' ? 'menu-dropdown-item-active' :
                                            'menu-dropdown-item-inactive'">
                                        Create Invoice
                                    </a>
                                </li>
                                <li>
                                    <a href="transactions.html" class="menu-dropdown-item group"
                                        :class="page === 'transactions' ? 'menu-dropdown-item-active' :
                                            'menu-dropdown-item-inactive'">
                                        Transactions
                                    </a>
                                </li>
                                <li>
                                    <a href="single-transaction.html" class="menu-dropdown-item group"
                                        :class="page === 'singleTransaction' ? 'menu-dropdown-item-active' :
                                            'menu-dropdown-item-inactive'">
                                        Single Transaction
                                    </a>
                                </li>
                ...
                <ul class="mb-6 flex flex-col gap-1">
                    ...
                    <li>
                        <a href="#" @click.prevent="selected = (selected === 'Support' ? '':'Support')"
                            class="menu-item group"
                            :class="(selected === 'Support') || (page === 'ticketLists' || page === 'ticketReply') ?
                            'menu-item-active' : 'menu-item-inactive'">
                            <svg :class="(selected === 'Support') || (page === 'ticketLists' || page === 'ticketLists') ?
                            'menu-item-icon-active' : 'menu-item-icon-inactive'"
                                width="24" height="24" viewBox="0 0 24 24" fill="none"
                                xmlns="http://www.w3.org/2000/svg">
                                <path
                            ...
                            <svg class="menu-item-arrow absolute top-1/2 right-2.5 -translate-y-1/2 stroke-current"
                                :class="[(selected === 'Support') ? 'menu-item-arrow-active' :
                                    'menu-item-arrow-inactive', sidebarToggle ? 'xl:hidden' : ''
                                ]"
                                width="20" height="20" viewBox="0 0 20 20" fill="none"
                                xmlns="http://www.w3.org/2000/svg">
                            ...
                            <ul :class="sidebarToggle ? 'xl:hidden' : 'flex'"
                                ...
                                <li>
                                    <a href="support-tickets.html" class="menu-dropdown-item group"
                                        :class="page === 'ticketLists' ? 'menu-dropdown-item-active' :
                                            'menu-dropdown-item-inactive'">
                                        Ticket List
                                    </a>
                                </li>
                                <li>
                                    <a href="support-ticket-reply.html" class="menu-dropdown-item group"
                                        :class="page === 'ticketReply' ? 'menu-dropdown-item-active' :
                                            'menu-dropdown-item-inactive'">
                                        Ticket Reply
                                    </a>
                                </li>
