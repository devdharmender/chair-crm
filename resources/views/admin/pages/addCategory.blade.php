                    ...
                    <tbody class="divide-y divide-gray-100 dark:divide-gray-800">
                        ...
                        @foreach ($catgdata as $item)
                            <tr>
                                ...
                                <td class="px-6 py-3 whitespace-nowrap">
                                    <div class="flex items-center justify-center">
                                        <svg @click="isModalOpen = !isModalOpen" id="{{$item->id}}"
        ...
        <div x-show="isModalOpen" class="fixed inset-0 flex items-center justify-center p-5 overflow-y-auto modal z-99999"
            ...
            <div @click.outside="isModalOpen = false"
                ...
                <div class="text-center">
                    ...
                    <h5 class="text-xl leading-6 text-gray-500 dark:text-gray-400">Your this action can't be rollback. Please think before you do this</h5>
