                            ...
                            <tr>
                                ...
                                <td class="px-6 py-3 whitespace-nowrap">
                                    <div class="flex items-center">
                                        <p class="text-gray-700 text-theme-sm dark:text-gray-400">
                                            {!! $data->blog_img ? '<a href="' . asset('storage/' . $data->blog_img) . '" target="_blank">View Image</a>' : 'No image found' !!}
                                ...
                                <td class="px-5 py-3 whitespace-nowrap">
                                    <div x-data="{ switcherToggle: {{ $data->blogstatus ? 'true' : 'false' }} }">
                                        <label for="{{ $data->id }}" class="cursor-pointer">
                                            <div class="relative"><input type="checkbox" id="{{ $data->id }}" 
                                ...
                                <td class="px-6 py-3 whitespace-nowrap">
                                    <div class="flex items-center justify-center">
                                        ...
                                        @click="isModalOpen = !isModalOpen" id="{{ $data->id }}"
                                        ...
                                        <a href="{{route('edit-blog-page',$data->id)}}">
            ...
            <div @click.outside="isModalOpen = false"
                ...
                <div class="text-center">
                    ...
                    <div class="flex items-center justify-center w-full gap-3 mt-7">
                        <button type="button" id="" class="dlt-confirm-btn flex justify-center w-full px-4 py-3 text-sm font-medium text-white rounded-lg bg-error-500 shadow-theme-xs hover:bg-error-600 sm:w-auto">
                            Yes, Delete it
                        </button>
                    </div>
                </div>
