...
@section('title', 'Chair-CRM : Edit Blog')
@section('main')
                        ...
                        <div class="-mx-2.5 flex flex-wrap gap-y-5">
                            <div class="w-full px-2.5 my-5">
                                <label class="mb-1.5 block text-sm font-medium text-gray-700 dark:text-gray-400">
                                    Blog Image <a href="{{ asset('storage/' . $BlogModel->blog_img) }}" target="_blank">(view Currenr Image)</a>
                                </label>
                            ...
                            <input type="hidden" name="blog_id" value="{{$BlogModel->id, old('title')}}"
                                    class="dark:bg-dark-900 shadow-theme-xs focus:border-brand-300 focus:ring-brand-500/10 dark:focus:border-brand-800 h-11 w-full rounded-lg border border-gray-300 bg-transparent px-4 py-2.5 text-sm text-gray-800 placeholder:text-gray-400 focus:ring-3 focus:outline-hidden dark:border-gray-700 dark:bg-gray-900 dark:text-white/90 dark:placeholder:text-white/30">
                            <div class="w-full px-2.5 xl:w-1/2">
                                <label class="mb-1.5 block text-sm font-medium text-gray-700 dark:text-gray-400">
                                    Title
                                </label>
                                <input type="text" placeholder="Enter title" name="title" id="titleInput" value="{{$BlogModel->title, old('title')}}"
                                    class="dark:bg-dark-900 shadow-theme-xs focus:border-brand-300 focus:ring-brand-500/10 dark:focus:border-brand-800 h-11 w-full rounded-lg border border-gray-300 bg-transparent px-4 py-2.5 text-sm text-gray-800 placeholder:text-gray-400 focus:ring-3 focus:outline-hidden dark:border-gray-700 dark:bg-gray-900 dark:text-white/90 dark:placeholder:text-white/30">
                            ...
                            <div class="w-full px-2.5 xl:w-1/2">
                                ...
                                <input type="text" placeholder="Enter meta title"name="metatitle" value="{{$BlogModel->metatitle, old('metatitle')}}"
                                    class="dark:bg-dark-900 shadow-theme-xs focus:border-brand-300 focus:ring-brand-500/10 dark:focus:border-brand-800 h-11 w-full rounded-lg border border-gray-300 bg-transparent px-4 py-2.5 text-sm text-gray-800 placeholder:text-gray-400 focus:ring-3 focus:outline-hidden dark:border-gray-700 dark:bg-gray-900 dark:text-white/90 dark:placeholder:text-white/30">
                                <span style="font-size: 1rem" class="text-theme-xs text-xl text-error-500 mt-1.5">
                                    @error('metatitle')
                                        {{ $message }}
                            ...
                            <div class="w-full px-2.5 xl:w-1/2">
                                ...
                                <input type="text" placeholder="Enter keywords" name="metakeyword" value="{{$BlogModel->metakeyword, old('metakeyword')}}"
                                    class="dark:bg-dark-900 shadow-theme-xs focus:border-brand-300 focus:ring-brand-500/10 dark:focus:border-brand-800 h-11 w-full rounded-lg border border-gray-300 bg-transparent px-4 py-2.5 text-sm text-gray-800 placeholder:text-gray-400 focus:ring-3 focus:outline-hidden dark:border-gray-700 dark:bg-gray-900 dark:text-white/90 dark:placeholder:text-white/30">
                                <span style="font-size: 1rem" class="text-theme-xs text-xl text-error-500 mt-1.5">
                                    @error('metakeyword')
                                        {{ $message }}
                            ...
                            <div class="w-full px-2.5 xl:w-1/2">
                                ...
                                <div
                                    ...
                                    <input type="text" name="canonicalurl" id="canonicalInput" value="{{$BlogModel->canonical,old('canonicalurl')}}"
                            ...
                            <div class="w-full px-2.5">
                                ...
                                <input type="text" name="metadesc" placeholder="Enter meta description" value="{{$BlogModel->metadesc, old('metadesc')}}"
                                    class="dark:bg-dark-900 shadow-theme-xs focus:border-brand-300 focus:ring-brand-500/10 dark:focus:border-brand-800 h-11 w-full rounded-lg border border-gray-300 bg-transparent px-4 py-2.5 text-sm text-gray-800 placeholder:text-gray-400 focus:ring-3 focus:outline-hidden dark:border-gray-700 dark:bg-gray-900 dark:text-white/90 dark:placeholder:text-white/30">
                                <span style="font-size: 1rem" class="text-theme-xs text-xl text-error-500 mt-1.5">
                                    @error('metadesc')
                                        {{ $message }}
                                ...
                                <div x-data="{ isOptionSelected: false }" class="relative z-20 bg-transparent">
                                    <select
                                        ...
                                        @foreach ($catgdata as $data)
                                            <option value="{{ $data->category_name }}" {{$data->category_name === $BlogModel->topic ? 'selected' : ''}}
                            ...
                            <div class="w-full px-2.5">
                                ...
                                <textarea rows="6" name="description"
                                    ...
                                    id="summernote"> {{$BlogModel->description, old('description')}}</textarea>
                                <span style="font-size: 1rem" class="text-theme-xs text-xl text-error-500 mt-1.5">
                                    @error('description')
                                        {{ $message }}
                                    @enderror
