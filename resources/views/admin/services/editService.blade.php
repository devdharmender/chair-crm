...
@section('title', 'Chair-CRM : Add Service')
@section('main')
                    ...
                    <form action="{{ route('update-service') }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="-mx-2.5 flex flex-wrap gap-y-5">
                            <div class="w-full px-2.5 my-5">
                                ...
                                <span class="imageerr text-error-500">
                                    @error('image')
                                        {{ $message }}
                                    @enderror
                                </span>
...
@endsection
@section('script')
    <script src="https://cdn.tiny.cloud/1/2zo19kfcjwbktqla81x3l9yio4qa8j7oktcimlz3b5ckw9sc/tinymce/8/tinymce.min.js"
        referrerpolicy="origin" crossorigin="anonymous"></script>
        <script>
            tinymce.init({
                selector: 'textarea#serviceeditor',
