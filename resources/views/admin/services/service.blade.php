                            ...
                            <tr>
                                ...
                                <td class="px-6 py-3 whitespace-nowrap">
                                    <div class="flex items-center">
                                        <p class="text-gray-700 text-theme-sm dark:text-gray-400">
                                            ...
                                            <a href="{{ asset('storage/') }}" target="_blank">View Image</a>
                                        </p>
                                    </div>
                                </td>
                                <td class="px-6 py-3 whitespace-nowrap">
                                ...
                                <td class="px-5 py-3 whitespace-nowrap">
                                    <div x-data="{ switcherToggle: 'false' }">
                                        <label for="dd" class="cursor-pointer">
                                ...
                                <td class="px-6 py-3 whitespace-nowrap">
                                    <div class="flex items-center justify-center">
                                        <svg class="dltbtn cursor-pointer hover:fill-error-500 dark:hover:fill-error-500 fill-gray-700 dark:fill-gray-400"
                                            @click="isModalOpen = !isModalOpen" id="1" width="20"
