                                ...
                                <td class="px-6 py-3 whitespace-nowrap">
                                    <div>
                                        <div x-data="{ isOptionSelected: false }" class="relative z-20 bg-transparent">
                                            <select class="changeusertype dark:bg-dark-900 shadow-theme-xs focus:border-brand-300 focus:ring-brand-500/10 dark:focus:border-brand-800 h-11 w-full appearance-none rounded-lg border border-gray-300 bg-transparent bg-none px-4 py-2.5 pr-11 text-sm text-gray-800 placeholder:text-gray-400 focus:ring-3 focus:outline-hidden dark:border-gray-700 dark:bg-gray-900 dark:text-white/90 dark:placeholder:text-white/30" :class="isOptionSelected & amp; & amp; 'text-gray-800 dark:text-white/90'"
                                ...
                                <td class="px-5 py-3 whitespace-nowrap">
                                    <div x-data="{ switcherToggle: {{ $user->status === 'active' ? 'true' : 'false' }} }">
                                        <label for="{{ $user->user_id }}-status" class="cursor-pointer">
                                            <div class="relative"><input type="checkbox" id="{{ $user->user_id }}-status" 
